...
from app.routers.Users import Users_register, Users_login, Users_dashboard, password_update
...
app.include_router(password_update.router, tags=["Password Update"])
app.include_router(alogin.router, prefix="/admin", tags=["Login"])
app.include_router(alogin.router, prefix="/admin", tags=["Logout"])
